...
from Backend.app.llm_query_processing_local import router as llm_query_local_router
...
from app.llm_query_proessing_hosted import router as llm_query_hosted_router
app = FastAPI()
...
app.include_router(llm_query_local_router, prefix="/llm-query")
...
app.include_router(llm_query_hosted_router, prefix="/llm-query-hosted")
